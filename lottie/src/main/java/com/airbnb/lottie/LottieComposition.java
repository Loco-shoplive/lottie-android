...
public class LottieComposition {
  ...
  private LinkedHashMap<Long, FontCharacter> characters;
  private LinkedHashMap<Long, Layer> layerMap;
  ...
  public void init(Rect bounds, float startFrame, float endFrame, float frameRate,
      List<Layer> layers, LinkedHashMap<Long, Layer> layerMap, Map<String,
      List<Layer>> precomps, Map<String, LottieImageAsset> images,
      LinkedHashMap<Long, FontCharacter> characters, Map<String, Font> fonts,
      List<Marker> markers) {
    this.bounds = bounds;
  ...
  public LinkedHashMap<Long, FontCharacter> getCharacters() {
    return characters;
  }
